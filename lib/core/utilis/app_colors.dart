...
class AppColors {
  ...
  static const Color splashColor=Color(0xFF6A9EDB);
  static const Color primary300pacity = Color(0x4D004182);
  static const Color whiteColor = Color(0xFFFFFFFF);
  static const Color blackColor = Color(0xFF000000);
  static const Color hintTextColor = Color(0xB3000000);
  static const Color primaryDark = Color(0xFF60004F);
  static const Color primaryDarkLight = Color(0x99004F4F);
  static const Color searchHintColor = Color(0x99004F4F);
  ...
  static const Color lightYellowColor = Color(0xFFFFF8D);
